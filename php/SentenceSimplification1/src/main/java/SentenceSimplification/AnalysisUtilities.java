...
public class AnalysisUtilities {
	private AnalysisUtilities() {
		...
		String conjugatorFilePath = "C:/Software/xampp/htdocs/glint/php/SentenceSimplification1/src/main/resources/config/verbConjugations.txt";
				//ClassLoader.getSystemResource("config/verbConjugations.txt").getFile().replaceAll("%20"," ");
